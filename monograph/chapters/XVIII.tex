...
\chapter[\texorpdfstring{XVIII. The unitary remainder in rank $d$}{XVIII. The unitary remainder in rank d}]{\texorpdfstring{Algorithmic non-commutative class field theory, XVIII: the unitary remainder in rank $d$}{Algorithmic non-commutative class field theory, XVIII: the unitary remainder in rank d}}\label{chap:XVIII}
\chaptermark{XVIII}
