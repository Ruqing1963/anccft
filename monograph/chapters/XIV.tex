...
\chapter{Algorithmic non-commutative class field theory, XIV: the graph $\cL$-invariant as spectral action, Bloch effective mass and Albanese length, and what the cyclic Chern character sees}\label{chap:XIV}
\chaptermark{XIV}
...
(b) The rank-two analogue for the $\widetilde A_2$ towers of [X]--[Ch.~\ref{chap:XII}], where $b_1=0$ [Ch.~\ref{chap:XII}]
