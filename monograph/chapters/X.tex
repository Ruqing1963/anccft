...
\chapter{Algorithmic non-commutative class field theory, X: $\Atwo$ complexes, higher simplicial Laplacians, and the fate of the trace obstruction in
rank two}\label{chap:X}
\chaptermark{X}
...
group arithmetic; (d) towers of $\Atwo$ complexes (the natural continuation of [III]--[Ch.~\ref{chap:IX}]).
