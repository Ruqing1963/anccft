% generated from Paper 3/anccft3.tex
\chapter[III. The Iwahori--Hecke tower and the type III dissolution of the trace obstruction]{Algorithmic non-commutative class field theory, III: the Iwahori--Hecke tower and the type III dissolution of the trace obstruction}\label{chap:III}
\chaptermark{III}
...
[Ch.~\ref{chap:II}, Thm.~1.6]). This paper takes the projective limit over the tower and determines
what survives.

Section~\ref{III:sec:type} proves that the geometric tail equivalence relation on the
...
Section~\ref{III:sec:euler} formalizes the finding of [Ch.~\ref{chap:II}, Rem.~5.2]: the congruence
...
making Section~\ref{III:sec:euler} unconditional; the full law follows in two lines, and
...
Theorem~\ref{III:thm:type} and its supporting lemmas are proved here in full up to two
...
$\mathrm{III}_\lambda$ factor for $0<\lambda<1$. Corollary~\ref{III:cor:dissolve} and
Proposition~\ref{III:prop:inductive} are complete. Section~\ref{III:sec:euler} is now
unconditional: the line-digraph recursion, previously a five-level computational
hypothesis, is proved in full as Theorem~\ref{III:thm:recursion}, self-containedly and
...
theorem rather than support a hypothesis. Section~\ref{III:sec:outlook} derives nothing
beyond one exactly verified bookkeeping identity, clearly labelled.

\section{The type of the limit, and what dissolves}\label{III:sec:type}
...
Under the identifications of [Ch.~\ref{chap:I}, \S1], $\Omega\cong\partial X\cong\varprojlim_kV_{Y_k}$
...
\begin{lemma}[Radon--Nikodym cocycle]\label{III:lem:rn}
...
\begin{lemma}[Ergodicity]\label{III:lem:ergodic}
...
\begin{theorem}[Ratio set of the geometric tail relation]\label{III:thm:ratio}
$r_\infty(\cR,\nu)=q^{\Z}\cup\{0\}$.
\end{theorem}

\begin{proof}
\emph{Upper bound.} By Lemma~\ref{III:lem:rn} the derivative of every partial isomorphism
...
derivative $q$ by Lemma~\ref{III:lem:rn}. The bad set inside the domain is
\[
...
\begin{theorem}[Type of the limit]\label{III:thm:type}
...
density argument of Theorem~\ref{III:thm:ratio} applies verbatim --- in particular for the
Satake-twisted cocycle classes of [Ch.~\ref{chap:I}, \S2] whose weights range in $q^{-\beta\Z}$ ---
...
(the level-$N$ truncations of [Ch.~\ref{chap:I}, Def.~1.6]); $\nu$ is quasi-invariant
(Lemma~\ref{III:lem:rn}) and ergodic (Lemma~\ref{III:lem:ergodic}), so $M_\infty$ is an
...
$0<\lambda<1$ gives type $\mathrm{III}_\lambda$. Theorem~\ref{III:thm:ratio} gives
...
\begin{remark}[A correction to the loose phrasing of {[Ch.~\ref{chap:I}, Thm.~2.4(iii)]}]
\label{III:rem:correction}
...
Theorem~\ref{III:thm:type} --- and the correct statement is the cocycle-range statement
proved above. We record this as a correction of emphasis to [Ch.~\ref{chap:I}], not of any equation.
\end{remark}

\subsection{Dissolution, and its exact purchase}

\begin{corollary}[Dissolution of formulation]\label{III:cor:dissolve}
...
finite-level obstruction mechanism of [Ch.~\ref{chap:II}, Thms.~1.5--1.6] --- non-negativity of
...
\begin{proposition}[Inductive persistence]\label{III:prop:inductive}
...
[Ch.~\ref{chap:II}, Thm.~1.6], and a fortiori no inductive limit
$\cE_\infty=\varinjlim\cE_k$ realizes $[\mathsf D_p]_\infty$.
\end{proposition}

\begin{proof}
Level by level, [Ch.~\ref{chap:II}, Thm.~1.6]; there is nothing to add, which is the point.
\end{proof}

\begin{remark}[What dissolution buys, and what it destroys]\label{III:rem:honest}
Corollary~\ref{III:cor:dissolve} and Proposition~\ref{III:prop:inductive} bracket the truth
...
which we state as the successor to [Ch.~\ref{chap:II}, Conj.~3.6(iii)], is accordingly: does there
...
\texorpdfstring{$K$}{K}-theory alive}\label{III:subsec:kirchberg}

\begin{proposition}[$C^*$-dissolution, no $K$-annihilation]\label{III:prop:kirchberg}
Let $C^*_r(\cG_\infty)$ denote the reduced groupoid $C^*$-algebra of the rooted tail
groupoid of [Ch.~\ref{chap:I}, Def.~1.6] over $\Omega$. It is a unital Kirchberg algebra: separable,
...
\]
by stabilization to the Cuntz algebra $\mathcal O_q$ $($[Ch.~\ref{chap:I}, Prop.~1.7(iii)]$)$.
Consequently, at the $C^*$-level the trace obstruction of [Ch.~\ref{chap:II}] has no formulation
\emph{and} $K$-theory is not annihilated: both properties denied to the von Neumann
closure of Corollary~\ref{III:cor:dissolve} and Remark~\ref{III:rem:honest} hold
simultaneously here.
\end{proposition}

\begin{remark}[What this algebra does not do, stated against temptation]
\label{III:rem:blindagain}
...
results: the boundary channel is arithmetically blind ([Ch.~\ref{chap:I}, Thm.~3.7]), its $K$-theory
seeing only $\Z/(q-1)$ locally and Euler-characteristic data globally, and nothing of
$\Jac(Y_k)$. Proposition~\ref{III:prop:kirchberg} therefore proves an \emph{existence of
...
Remark~\ref{III:rem:honest} stands exactly as posed: construct, functorially from the
...
\section{The Iwahori--Hecke Euler characteristic}\label{III:sec:euler}

The congruence (Iwahori path) tower of [Ch.~\ref{chap:II}, \S5] has levels
...
truncation), and it is non-normal: no deck group acts, and [Ch.~\ref{chap:II}, Rem.~5.2] showed its
...
\begin{theorem}[Line-digraph recursion, proved]\label{III:thm:recursion}
...
this is the five-level-verified $2^{\,n_k-1}$ of [Ch.~\ref{chap:II}, Rem.~5.2], whose exponent is a
...
$Q=D_{\mathrm{in}}^{\,t}$,
\begin{equation}\label{III:eq:abba}
...
\begin{equation}\label{III:eq:prodform}
\prod_{\mu\in\operatorname{Spec}\Delta\setminus\{0\}}\mu\;=\;N\,\kappa .
\end{equation}

\emph{Step 3 (assembly).} Apply \eqref{III:eq:prodform} to $G$ and to $L(G)$. By
\eqref{III:eq:abba}, the nonzero eigenvalues of $\Delta_{L(G)}=qI_m-A(L(G))$ are those of
...
\begin{theorem}[The pseudo-Iwasawa law]\label{III:thm:pseudo}
Let the base graph have $n$ vertices and $q=p$. Then, unconditionally by
Theorem~\ref{III:thm:recursion},
for $k\ge2$,
\[
...
\begin{proof}
Summing the recursion of Theorem~\ref{III:thm:recursion} from level $1$,
\[
...
\begin{proposition}[$\lambda\ge0$ for commutative Iwasawa towers]\label{III:prop:lampos}
...
generated torsion $\Z_p[[T]]$-module can exhibit $\lambda=-1$: Theorem~\ref{III:thm:pseudo}
...
\begin{definition}[Degeneracy pair and its Euler term]\label{III:def:degeneracy}
...
\begin{theorem}[The $-1$ is an Euler characteristic]\label{III:thm:euler}
The transfer of torsion along one level of the Iwahori tower factors, by
Theorem~\ref{III:thm:recursion}, as
\[
...
kernel removed at each level. Hence in the growth law of Theorem~\ref{III:thm:pseudo} the
...
$\Z_p[[T]]$. In particular the corrected form of [Ch.~\ref{chap:II}, Conj.~3.6(ii-b)] should assert
...
Newton identities of [Ch.~\ref{chap:II}, \S5] hold to the integer.
\end{theorem}

\begin{proof}
The recursion's exponent splits as $(m_k-n_k)-1=\ord_p(q^{\,m_k-n_k})-1$, and both
terms are now located inside the proof of Theorem~\ref{III:thm:recursion} itself. The
...
\eqref{III:eq:prodform}. The subtracted $1$ is the vertex-count normalization
$n_k/m_k=q^{-1}$ in \eqref{III:eq:prodform}: precisely the one-dimensional Eisenstein
...
as in Theorem~\ref{III:thm:pseudo} turns the per-level $-\chi_k=-1$ into the global
$-k$, i.e.\ $\lambda=-\chi=-1$.
\end{proof}

\begin{remark}[Honest scope]\label{III:rem:scope2}
Theorem~\ref{III:thm:euler} is now unconditional, but its final sentence remains a
proposal for restating
[Ch.~\ref{chap:II}, Conj.~3.6(ii-b)], not a theorem about $\cH(\PGL_2(\Q_p),\cI)$-modules: we have
...
unconditional is Proposition~\ref{III:prop:lampos}: $\lambda=-1$ certifies, rigorously,
that whatever that theory is, it is not commutative Iwasawa theory.
\end{remark}

\section{Exploratory outlook}\label{III:sec:outlook}
...
(Remark~\ref{III:rem:honest}), where the natural analytic invariants are not traces but
the KMS functionals of the twisted dynamics of [Ch.~\ref{chap:I}, \S2], with local $L$-factors as
partition functions. The Euler-characteristic correction of
Section~\ref{III:sec:euler} lives at the trivial zero of those $L$-factors --- the same
...
$g(T)=T^2h(T)$ for the cleared voltage pencil (the double trivial zero of [Ch.~\ref{chap:II}, Rem.~5.4]) and
...
satisfies, exactly in all four abelian towers of [Ch.~\ref{chap:II}, Table~2],
\[
...
Unrefereed preprint. Proved in full: Lemmas~\ref{III:lem:rn}--\ref{III:lem:ergodic},
Theorem~\ref{III:thm:ratio}, Corollary~\ref{III:cor:dissolve},
Propositions~\ref{III:prop:inductive} and~\ref{III:prop:lampos},
Theorem~\ref{III:thm:recursion} (self-contained; the only classical input is the
algebraic simplicity of the Perron eigenvalue of an irreducible non-negative matrix),
Theorem~\ref{III:thm:pseudo}, and Theorem~\ref{III:thm:euler}, all now unconditional.
...
\cite{LevineIII} is retained for priority context only: Theorem~\ref{III:thm:recursion} is
proved self-containedly above, and comparing the exponent $q^{\,n(q-1)-1}$ with the
published statement belongs to the primary-source check this series requires. The concluding restatement of [Ch.~\ref{chap:II}, Conj.~3.6(ii-b)] in
Theorem~\ref{III:thm:euler} remains a proposal.
Remark~\ref{III:rem:correction} records a correction of emphasis to [Ch.~\ref{chap:I}, Thm.~2.4(iii)].
Section~\ref{III:sec:outlook} makes no claims.
