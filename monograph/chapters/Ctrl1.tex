...
\chapter[Power-sum lower bounds on hidden eigenvalues in positive realizations]{Power-sum lower bounds on hidden eigenvalues in positive realizations}\label{chap:Ctrl1}
\chaptermark{Ctrl1}
...
[Ch.~\ref{chap:II}] --- while in the present setting the same negative $p_2$ merely counts
