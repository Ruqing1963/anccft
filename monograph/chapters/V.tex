...
\chapter[V. The degeneracy structure of the Iwahori tower and the Euler correction]{Algorithmic non-commutative class field theory, V: the degeneracy structure of the Iwahori tower and the Euler correction}\label{chap:V}
\chaptermark{V}
...
edges, $\ta\etp=T_p$, the Hecke operator of {\rm[Ch.~\ref{chap:I}]}.
\end{proposition}
