...
\chapter[\texorpdfstring{XI. The $\PGL_3$ positive Hecke-dynamical system: shift equivalence over $\Z$ and the geodesic
edge flow}{XI. The PGL3 positive Hecke-dynamical system: shift equivalence over Z and the geodesic edge flow}]{\texorpdfstring{Algorithmic non-commutative class field theory, XI: the $\PGL_3$ positive Hecke-dynamical system: shift equivalence over $\Z$ and the geodesic
edge flow}{Algorithmic non-commutative class field theory, XI: the PGL3 positive Hecke-dynamical system: shift equivalence over Z and the geodesic edge flow}}\label{chap:XI}
\chaptermark{XI}
...
$\Z$ to $\Cthree$, as a corollary of [Ch.~\ref{chap:X}]'s ``Boyle--Handelman spectral conditions''. Those conditions give the nonzero spectrum
