...
\chapter[\texorpdfstring{IX. Exceptional zeros, the graph $\cL$-invariant, and the operator-algebraic
Mazur--Tate--Teitelbaum formula}{IX. Exceptional zeros, the graph L-invariant, and the operator-algebraic Mazur-Tate-Teitelbaum formula}]{\texorpdfstring{Algorithmic non-commutative class field theory, IX: exceptional zeros, the graph $\cL$-invariant, and the operator-algebraic
Mazur--Tate--Teitelbaum formula}{Algorithmic non-commutative class field theory, IX: exceptional zeros, the graph L-invariant, and the operator-algebraic Mazur-Tate-Teitelbaum formula}}\label{chap:IX}
\chaptermark{IX}
...
\section{\texorpdfstring{The $\ell$-adic bookkeeping}{The l-adic bookkeeping}}\label{IX:sec:book}
...
\section{\texorpdfstring{The Iwahori tower: a simple zero and no $\cL$-invariant}{The Iwahori tower: a simple zero and no L-invariant}}\label{IX:sec:iwahori}
