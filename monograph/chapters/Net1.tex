...
\chapter[\texorpdfstring{The sign of $\lambda$: an algebraic certificate for how a graph tower is generated}{The sign of lambda: an algebraic certificate for how a graph tower is generated}]{\texorpdfstring{The sign of $\lambda$: an algebraic certificate for how a graph tower is generated}{The sign of lambda: an algebraic certificate for how a graph tower is generated}}\label{chap:Net1}
\chaptermark{Net1}
...
\section{\texorpdfstring{Where the $-1$ comes from}{Where the -1 comes from}}\label{Net1:sec:where}
