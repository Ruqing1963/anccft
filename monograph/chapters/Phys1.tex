...
\renewcommand{\Yt}{\widetilde Y_{\bm\alpha}}
\chapter[Effective mass from spanning trees, and the absence of Bloch phases on rank-two hyperbolic lattices]{Effective mass from spanning trees, and the absence of Bloch phases on rank-two hyperbolic lattices}\label{chap:Phys1}
\chaptermark{Phys1}
...
Ref.~[Ch.~\ref{chap:XIV}], where $-n\lambda_0''(0)/2$ was identified with an
...
(X) & $H$ reproduces Refs.~[Chs.~\ref{chap:IX}, \ref{chap:XIV}] & $4/4$ & exact\\
...
Refs.~[Chs.~\ref{chap:IX}, \ref{chap:XIV}].}
...
Ref.~[Ch.~\ref{chap:X}]: the complexes of Table~\ref{Phys1:tab:ranktwo} are abelian covers of
...
Ref.~[Ch.~\ref{chap:XIV}], Theorem~4.2; Eq.~\eqref{Phys1:eq:trees} for $d=1$ is
Ref.~[Ch.~\ref{chap:IX}], Theorem~1.2(iv); Theorem~\ref{Phys1:thm:nogo}(i) is
Ref.~[Ch.~\ref{chap:XII}], Theorem~1.1, which in turn quotes Refs.~\onlinecite{Ga,BSw}. The
...
are those of Ref.~[Ch.~\ref{chap:X}].
\end{acknowledgments}
