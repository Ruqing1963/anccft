...
\chapter{Algorithmic non-commutative class field theory, XVI: the out-covering correspondence of the head map, its $K_0$-index $\et$, and the
$\KK$-category of the Iwahori tower}\label{chap:XVI}
\chaptermark{XVI}
