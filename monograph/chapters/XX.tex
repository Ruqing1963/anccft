...
\renewcommand{\LE}{L_E}
\chapter{Algorithmic non-commutative class field theory, XX: the invariant subspace in rank $d$, and one flag count that produces it}\label{chap:XX}
\chaptermark{XX}
...
$(d,q)\in\{(2,2),(2,3),(3,2),(3,3),(4,2)\}$ and every $i$, fourteen triples in all; checks
