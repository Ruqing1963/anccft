...
A companion paper [Ch.~\ref{chap:Bio1}] showed that the number of reconstructions of a circular
...
reconstructions [Ch.~\ref{chap:Bio1}, Rem.~1]. Fix a sink $s\in V$ and let $\Arb(G)$ be the set of
...
By the contraction lemma of [Ch.~\ref{chap:Bio1}, Lem.~4], both $\K(G)$ and, arc for arc, $\Arb(G)$
...
statistics \emph{do} see. The torsor lives on what remains, which [Ch.~\ref{chap:Bio1}] showed is
...
[Ch.~\ref{chap:Bio1}, Tab.~1]. Theorem~\ref{Bio2:thm:torsor} says that the $12$-mer spectrum of the phage
...
This is precisely the situation of the interleaving theorem [Ch.~\ref{chap:Bio1}, Thm.~6] at $s=1$:
...
\cite{ABCS,KSP}; the spectrum of $\varphi$X174 and the interleaving theorem [Ch.~\ref{chap:Bio1}].
