...
The central open problem of this series --- posed in [Ch.~\ref{chap:III}, Rem.~1.9] and sharpened
...
$B(Y)$ is not shift equivalent to the Ihara companion $C$ of {\rm[Ch.~\ref{chap:II}]}: already
$\Tr B(Y)=2n\neq0=\Tr C$, and Lemma~{\rm[Ch.~\ref{chap:II}, ~1.4]} makes traces shift-equivalence
...
spectra; $K$-theory is a cokernel invariant; and Remark~[Ch.~\ref{chap:II}, after Thm.~1.6]
...
the target fixed by [Ch.~\ref{chap:I}, Thm.~3.5], [Ch.~\ref{chap:III}, Rem.~1.9] and [Ch.~\ref{chap:IV}] is
...
\emph{Solved:} the single-level canonicity problem of [Ch.~\ref{chap:III}, Rem.~1.9] --- a
